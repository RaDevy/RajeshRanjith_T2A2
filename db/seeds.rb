...
Product.new(title:"Trousers", description:"Hemp based pants that are amazing", price:50, user_id:1).save!
Product.new(title:"soap", description:"An eco-friendly alternative", price:20, user_id:1).save!
